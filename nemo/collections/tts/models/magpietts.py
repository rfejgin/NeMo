...
class MagpieTTSModel(ModelPT):
    ...
    def clear_forbidden_logits(self, logits, forbid_audio_eos=False):
        ...
        """
        logits[:, :, SpecialAudioToken.get_forbidden_tokens(self._codec_model.codebook_size, forbid_audio_eos=forbid_audio_eos)] = float('-inf')
        return logits

    def local_transformer_sample_maskgit(self, dec_output, temperature=0.7, topk=80, unfinished_items={}, finished_items={}, use_cfg=False, cfg_scale=1.0, n_steps=3, noise_scale=0.0, fixed_schedule=None, dynamic_cfg_scale=False, sampling_type=None, forbid_audio_eos=False):
        """
    ...
    def local_transformer_sample_autoregressive(self, dec_output, temperature=0.7, topk=80, unfinished_items={}, finished_items={}, use_cfg=False, cfg_scale=1.0, use_kv_cache=True, forbid_audio_eos=False):
        # dec_output: (B, E)
